  ...
  properties: {
    ...
    displayPassword: {
      ...
      bindingValidation: {
        type: "boolean",
        tooltip:
          "A boolean that defines if the input should display the password: `true | false`",
      },
      /* wwEditor:end */
    },
    readonly: {
    ...
    step: {
      ...
      options: (content) =>
        content.type === "decimal"
          ? {
              min: 0,
              max: 10 * parseFloat(content.precision),
              step: parseFloat(content.precision),
            }
          : { min: 1, max: 100, step: 1 },
      defaultValue: 1,
      bindable: true,
      hidden: (content) =>
        content.type !== "decimal" && content.type !== "number",
    },
    placeholder: {
      ...
      bindingValidation: {
        ...
        tooltip:
          'A string or a number depending on the type of input chosen: `42`, `"My placeholder"`',
      },
      /* wwEditor:end */
    },
    rows: {
    ...
    min: {
      ...
      section: "settings",
      hidden: (content) =>
        content.type !== "number" && content.type !== "decimal",
      defaultValue: "0",
      bindable: true,
      /* wwEditor:start */
      bindingValidation: {
